              ...
              >
                {filteredTemplates.map((template) => (
                  <motion.div key={template.id} variants={itemVariants}>
                    <Card
                      className="group relative flex h-full cursor-pointer flex-col rounded-[2rem] transition-all hover:border-primary/30 hover:shadow-lg"
                    ...
                    >
                      <CardHeader className="p-6 sm:p-7">
                        ...
                        <CardTitle className="mt-4 text-xl font-black leading-tight tracking-tight transition-colors group-hover:text-primary">
                          {template.name}
                        </CardTitle>
                      ...
                      <CardContent className="mt-auto p-6 pt-0 sm:p-7 sm:pt-0">
                        <div className="mb-4">
                          <span className="rounded-lg border border-primary/10 bg-primary/10 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-primary">
                            {template.category}
                          </span>
                        </div>
                        <div className="flex items-center gap-4 border-t border-foreground/[0.05] pt-4 text-[11px] font-bold uppercase tracking-widest text-muted-foreground/60">
